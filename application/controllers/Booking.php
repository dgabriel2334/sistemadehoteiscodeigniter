...
class Booking extends BaseController
{
    ...
    {
        $this->global['pageTitle'] = ' : Book the room';
    ...
    function editOldBooking($bookingId = NULL)
    {
        ...
        $this->global['pageTitle'] = ' : Edit Booking - '. $bookingDetails->customerName . ' (' . date('Y-m-d', strtotime($bookingDetails->bookStartDate)) . ' to '. date('Y-m-d', strtotime($bookingDetails->bookEndDate)) . ' )';
