...
class BaseFare extends BaseController
{
    ...
    function baseFareListing()
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = ' Lista de valores';
    ...
    function addNewBaseFare()
    {
        ...
        {
            $this->global['pageTitle'] = ' Adicionar  novo valor/taxa';
            $this->load->model("rooms_model");
            $data['roomSizes'] = $this->rooms_model->getRoomSizes();
    ...
    function addedNewBaseFare()
    {
        ...
        else
        {
            ...
            $this->form_validation->set_rules('serviceTax','Taxa de serviço','trim|required|numeric');
            $this->form_validation->set_rules('serviceCharge','Taxa de administração','trim|required|numeric');
    ...
    function editOldBaseFare($bfId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = ' : Edit Base Fare';
