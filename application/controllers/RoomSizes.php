...
class RoomSizes extends BaseController
{
    ...
    function roomSizesListing()
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Tamanhos de quarto';
    ...
    function addNewRoomSize()
    {
        ...
        {
            $this->global['pageTitle'] = 'Adicionar novo tamanho';
    ...
    function addedNewRoomSize()
    {
        ...
        else
        {
            ...
            $this->form_validation->set_rules('sizeTitle','Título do novo tamanho','trim|required|max_length[256]');
            $this->form_validation->set_rules('sizeDescription','Descrição do novo tamanho','trim|required');
    ...
    function editOldRoomSize($roomSizeId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = ' : Edit Room Size';
