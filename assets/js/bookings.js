...
$(document).ready(function(){
    ...
    var checkDates = function() {
        ...
        if(startDate == '' || endDate == '') {
            $('#dateValidationMsg').html('Insira as datas corretamente!');
            $('#validationDiv').show();
            return false;
        } else {
            var startJSDate = new Date(startDate); startJSDate.setHours(0, 0, 0, 0);
           ...
           if(dates.compare(todayDate, endJSDate) == 1) {
                $('#dateValidationMsg').html('A data final tem que ser igual ou maior a hoje!');
                $('#validationDiv').show();
                return false;
            }
            else if(dates.compare(startJSDate, endJSDate) == 1) {
                $('#dateValidationMsg').html('A data final tem que ser maior ou igual a data inicial');
                $('#validationDiv').show();
                return false;
            }
        }
