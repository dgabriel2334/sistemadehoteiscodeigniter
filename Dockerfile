...
RUN curl -Lo xampp-linux-installer.run "https://sinalbr.dl.sourceforge.net/project/xampp/XAMPP%20Linux/7.4.33/xampp-linux-x64-7.4.33-0-installer.run?from_af=true" && \
